...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "CHANGELOG.rdoc", "README.rdoc", "bin/knights_tour", "lib/knights_tour.rb", "spec/knights_tour_spec.rb"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/tuomas/knights_tour}
  s.rdoc_options = ["--title", "Knight's Tour 0.3.3", "--main", "README.rdoc", "--exclude", "spec", "--line-numbers"]
  s.require_paths = ["lib"]
